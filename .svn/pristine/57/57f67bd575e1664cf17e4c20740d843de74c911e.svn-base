...
namespace CCAPortal.Controllers
{
    public class SMSTemplatesController : Controller
    {
        ...
        public ActionResult Save(Templates templates)
        {
            ...
            {
                Templates Result = dLTemplates.SaveSMSTemplate(templates, Session["OrgID"].ToString(), Session["UserID"].ToString());
        ...
        public ActionResult TemplateList()
        {
            ...
            try
            {
                result = dLTemplates.GetSMSTemplates(Session["OrgID"].ToString());
            }
            catch (Exception ex)
            {
        ...
        public ActionResult Update(Templates templates)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                return Json(new
                {
                    ...
                    AjaxReturn = PartialView("TemplateList", dLTemplates.GetSMSTemplates(Session["OrgID"].ToString()).ToList()).RenderToString()
                });
            }
            else
            {
